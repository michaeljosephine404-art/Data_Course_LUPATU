...
getwd() #working directory.. or click session, choose working directory 
...
letters # built-in pre-made vector of a - z ){question infront of comand takes you to help}
...
vector1 > 3
vector1 >= 3
vector1 < 5# each element is less than five in vector 1 true or false 
vector1 <= 5 # us less than or equal to 5 
vector1 == 7 #is equal to 7 in terms of number values has to be double equal signs , = is used for assigning to objects 
letters == "a"
letters != "c"
...
as.character(vector1) + 5  #returns an error co zyou added character to string
...
even_dat
str(even_dat) #check classes of each column 
...
iris_chr
str(iris_chr) #check class of each column 
